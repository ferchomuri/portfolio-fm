...
export function DeploymentsSection({ projects }: DeploymentsSectionProps) {
  return (
    <section
      id={DEPLOYMENTS_SECTION_CONFIG.SECTION_ID}
                ...
                >
                  ...
                  <div className="flex flex-col gap-3 pt-4 border-t border-zinc-900 sm:flex-row sm:gap-4">
                    <a
                      ...
                      data-cursor="pointer"
                    >
                      <span>{DEPLOYMENTS_SECTION_CONFIG.LAUNCH_LABEL}</span>
                    ...
                    <button
                      ...
                      disabled
                      aria-disabled="true"
                      title={DEPLOYMENTS_SECTION_CONFIG.SOURCE_UNAVAILABLE_TITLE}
                    ...
                    >
                      ...
                      <span>{DEPLOYMENTS_SECTION_CONFIG.SOURCE_LABEL}</span>
                    </button>
                  </div>
                </div>
              </motion.div>
